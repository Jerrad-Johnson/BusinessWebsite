...
function calculateGalleryLayout(galleryInputCopy, galleryElementRef){
    ...
    const autoGeneratedWidth = Math.trunc(+galleryElementRef.offsetWidth-4); // -4 because otherwise at some widths, the last image in a row jumps to the next row. Total width might be e.g. 0.42 pixels too large.
