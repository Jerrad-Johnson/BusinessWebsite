...
function MyImageGallery(inputs) {
    const delinkedInputsForErrorChecker = {...inputs}
    ...
    const maxRows = delinkedInputs.maxRows || Number.POSITIVE_INFINITY;
...
function calculateGalleryLayout(calculatorInputs, galleryContainer){
    const delinkCalculatorInputs = {...calculatorInputs}
