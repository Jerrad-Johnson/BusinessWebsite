...
function checkInputForErrors(galleryInput){
    ...
    const {containerPadding, images, targetRowHeight} = galleryInputCopy;

    if (!images) throw new Error("You must include images.");
    if (typeof targetRowHeight !== "number") throw new Error("Target row height must be a number, not a string.");
