...
function MyImageGallery({
    ...
    if (typeof document !== "undefined") {
        ...
        useEffect(() => {
            setGalleryElements(calculateGalleryLayout());
            window.addEventListener('resize', () => setGalleryElements(calculateGalleryLayout()));
            return () => {
                window.removeEventListener('resize', () => setGalleryElements(calculateGalleryLayout()));
            }
        }, []);
    }
