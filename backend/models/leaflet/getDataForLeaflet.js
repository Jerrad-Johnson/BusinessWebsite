...
exports.getDataForLeaflet = async (req, res, next) => {
    ...
    const query = "SELECT url, file_name, alt_text, camera_model, lens_model, photo_capture, folder, file_name_full, folder, (?) AS longitude, (?) AS latitude FROM leaflet_images;";
