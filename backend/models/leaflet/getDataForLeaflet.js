...
exports.getDataForLeaflet = async (req, res, next) => {
    ...
    const query = `SELECT gallery_lg_images.url, gallery_lg_images.width, gallery_lg_images.height, gallery_lg_images.file_name, 
        gallery_lg_images.alt_text, gallery_lg_images.camera_model, gallery_lg_images.lens_model, gallery_lg_images.photo_capture, 
        gallery_lg_images.folder, gallery_lg_images.file_name_full, (?) AS longitude, (?) AS latitude FROM gallery_lg_images 
