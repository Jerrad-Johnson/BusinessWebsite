const fs = require('fs');
const {pathToLocalFSGalleries, errorExistsInScript, errorExistsNotInScript, cc} = require("../../../common/variables");
...
exports.getFilenamesForMapUpdate = async (foldernames) => {
    ...
    for (let entry of foldernames){
        ...
        let files = await fs.promises.readdir(`${pathToLocalFSGalleries}/${entry}`, {}, (err) => {
